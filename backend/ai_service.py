...
TOOL_DOCS = {
    "check_availability": '- check_availability : args {"tanggal_checkin":"YYYY-MM-DD","tanggal_checkout":"YYYY-MM-DD" (opsional, menginap >1 malam),"tipe":__ROOM_TIPE__ (opsional),"jumlah_kamar":angka (opsional, isi kalau tamu sebutkan berapa kamar yang dia butuhkan)}. '
