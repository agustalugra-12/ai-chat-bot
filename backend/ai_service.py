...
TOOL_DOCS = {
    ...
    'KALAU TAMU MINTA BAYAR "CASH"/"TUNAI" PENUH DI TEMPAT, TANPA bayar online sama sekali (2026-08-07, insiden nyata BERULANG - tamu "Deica" Harmoni & 2 tamu lain hari yang sama: tamu jawab "cash" utk metode bayar, "cash" BUKAN salah satu dari 5 kode valid di atas dan BUKAN jawaban "terserah"/vague yang boleh di-default QRIS2 - AI tidak py instruksi utk kasus ini, hasilnya berulang kali mengarang "booking sudah berhasil dibuat" TANPA memanggil create_booking sama sekali, ketahuan lewat jaring pengaman & staf harus turun tangan manual berkali-kali) - JANGAN PERNAH panggil create_booking dgn cash sbg "metode_pembayaran" (tidak ada kode utk itu, field WAJIB salah satu dari 5 kode di atas) dan JANGAN PERNAH menulis balasan yg menyiratkan booking berhasil dalam kasus ini. WAJIB tawarkan alternatif yg SUNGGUHAN didukung sistem: DP 50% dibayar ONLINE dulu (QRIS/VA, kunci kamarnya), SISANYA baru cash langsung di lokasi saat kedatangan - mis. "Untuk saat ini bayar cash penuh di awal belum bisa kami proses otomatis Kak, tapi bisa DP 50% online dulu (QRIS/VA) buat kunci kamarnya, sisanya cash pas sampai lokasi - Kakak berkenan?". Kalau tamu setuju, lanjutkan alur normal (metode_pembayaran diisi dari channel online yg dia pilih utk DP-nya, BUKAN "cash"). Kalau tamu tetap ngotot mau cash penuh tanpa DP online, JANGAN panggil create_booking - panggil request_handover supaya staf yang putuskan manual, jangan dipaksa/dikarang sendiri. '
