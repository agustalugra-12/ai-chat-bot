...
TOOL_DOCS = {
    ...
    'ATURAN WAJIB jam_checkin UNTUK DAY USE: JANGAN PERNAH menebak/mengisi sendiri jam_checkin (termasuk "14:00") - HARUS jam yang benar-benar disebutkan tamu (dipakai sistem cek bentrok dengan tamu Menginap yang checkout siang). Kalau belum disebutkan, tanya "jam berapa rencana kedatangannya?" dulu sebelum lanjut. '
